...
public class SensorUptimes {
    ...
    public String toString() {
        return "ClassPojo [unknown_up_time_count = " + unknown_up_time_count + ", low_up_time_count = " + low_up_time_count + ", high_up_time_count = " + high_up_time_count + "]";
    }
}
